...
- Откройте новое окно терминала и запустите shell командой `python manage.py shell`
- В открывшемся окне произведите импорт функции командой `from scripts import make_schoolkid_happy_again`
- Запустите скрипт командой `make_schoolkid_happy_again(schoolkid_name, subject_name)`, где:

` schoolkid_name - фамилия и имя ученика`

` subject_name - название предмета`

Например:

`make_schoolkid_happy_again("Иванова Алена", "Математика")`

Если при вводе вышуказанных данных возникает ошибка:

`"Найдено слишком много учеников. Пожалуйста, уточните запрос"` 
или
`"Не найдено ни одного ученика. Пожалуйста, проверьте запрос"` - введите последнюю команду еще раз, обратите внимание на правильность написания имени и фамилии (постарайтесь указывать и имя, и фамилию)

Если при вводе вышуказанных данных возникает ошибка:

`"Такой предмет не найден. Пожалуйста, проверьте запрос"` - проверьте правильность написания предмета (он должен быть написан с большой буквы)
